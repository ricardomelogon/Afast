<script>
	$(document).ready(function(e) {
		...
		$('#CadastrarExercicio').click(function(e) {
			...
			//alert(id);
			$('#docenteloader').load('docentes/docentes.exercicio.cadastrar.php', { id: id});
			}
    	});
				...
				$.ajax({
				   ...
				   success: function(data) {
						...
						if(data === 'true'){
							...
							$('#docenteloader').load('docentes/docentes.exercicios.php',{ id: id});
						}
						else{
		...
		$('.EditarItem').click(function(e) {
			...
			{
			var id = $(this).attr('id');
			$('#docenteloader').load('docentes/docentes.exercicios.editar.php',{ id: id});
			}
		});
...
<h2 class="text-center">Terminar ou Ativar Exercícios</h2>
