...
<h2 class="text-center">Cadastro de Docente</h2>
<br>
		...
		<div class="input-group">
			<div class="input-group-btn dropup">
				...
				<ul class="dropdown-menu">           	
                  ...
                  ?>
                        <li><a href="#" id=<?php echo $itemRow['id_curso']; ?> class="curso_select"><?php echo $itemRow['nome_curso']; ?></a></li>                      
                  <?php
                      }
                  }
                  ?>
			...
			<input id="id_curso" type="hidden"> <input type="text" class="form-control" id="curso_placeholder" disabled placeholder="Escolha um curso" aria-describedby="basic-addon1">
		</div>
	</section>
	<section class="col-md-4">
		<div class="input-group">
			<div class="input-group-btn">
				...
				<button type="button" class="btn btn-default" aria-haspopup="true" id="docente_cadastro_datepicker" aria-expanded="false">
