...
<script>
	...
	$('#Atualizar').click(function(e) {
		e.preventDefault();
		//loader
		$('#loader').load('administrador/administrador.lista.php');
		});
		
	$('#Adicionar').click(function(e) {
		e.preventDefault();
		//loader
		$('#loader').load('administrador/administrador.adicionar.php');
	});	
	...
	$('.EditarItem').click(function(e) {
		...
		var id = $(this).attr('id');
		//alert(id);
		$('#loader').load('administrador/administrador.editar.php', { id: id});
	});
...
<h2 class="text-center">Lista de Administradores Cadastrados</h2>
<br>
