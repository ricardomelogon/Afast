...
$count++;
echo  '<div class="containter well"> <!-- Well -->';
echo    '<section class="row"> <!-- Primeira Linha-->';
...
echo        '</section> <!-- Siape -->';
echo        '<input type="hidden" class="docenteid" value="'.$docenteRow['id_docente'].'">';
echo    '</section> <!-- Primeira Linha-->';
echo    '<hr class="hrferias"> <!-- Divisor -->';
echo    '<section class="row"><!-- Segunda Linha -->';
echo     '<section class="col-md-11"> <!-- Datas -->';
echo      '<section class="col-md-3"> <!-- Selecionar Datas-->';
...
echo        '<input type="hidden" id="valorferiastotal-'.$count.'">';
