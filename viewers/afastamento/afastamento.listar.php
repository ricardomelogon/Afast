...
<script>
	$(document).ready(function(e) {
		...
		$('.Voltar').click(function(e) {
			e.preventDefault();
			//alert("Voltar");
			$('#loader').load('../viewers/ocorrencias/ocorrencias.lista.php');
    	});
		...
		$('#Salvar').click(function(e) {
			...
			if ( dt_inicio_afastamento === "" || dt_fim_afastamento === "" || id_ocorrencia === ""  || id_docente === ""){
				...
				(function(id_afastamento, dt_inicio_afastamento, dt_fim_afastamento, id_docente, observ_afastamento, id_ocorrencia){
					$.ajax({
						...
						success: function(data) {
							...
							if (proceedOverlap) {
								...
								})(id_afastamento, dt_inicio_afastamento, dt_fim_afastamento, id_docente, observ_afastamento, id_ocorrencia); //Ajax2 Função
							} //If sobreposição
						} //Sucesso Ajax1
					}); //Ajax1
				})(id_afastamento, dt_inicio_afastamento, dt_fim_afastamento, id_docente, observ_afastamento, id_ocorrencia); //Ajax1 Função
			}
		});
...
<script type="text/javascript">
	...
	$("#id_docente").change(function(){
	    ...
	    $.ajax({
	        url: 'afastamento/call.afastamento.lista.php',
