...
(function($, window, undefined) {
	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [
				{text: 'Hoje', dateStart: function() { return moment() }, dateEnd: function() { return moment() } },
				{text: 'Ontem', dateStart: function() { return moment().subtract('days', 1) }, dateEnd: function() { return moment().subtract('days', 1) } },
				...
				{text: 'Prox 30 dias', dateStart: function() { return moment().startOf('month') }, dateEnd: function() { return moment() } },
				...
				{text: 'Proximo ano', dateStart: function() { return moment().startOf('year') }, dateEnd: function() { return moment() } }
			],
			initialText: 'Selecione as datas', // placeholder text - shown when nothing is selected
			icon: 'ui-icon-triangle-1-s',
			applyButtonText: 'Aplicar', // use '' to get rid of the button
			clearButtonText: 'Limpar', // use '' to get rid of the button
...
//				showCurrentAtPos: 1 // bug; use maxDate instead
				maxDate: 375 // the maximum selectable date is today (also current month is displayed on the last position)
			}
		},
	...
	function buildDateRangePicker($originalElement, instance, options) {
		...
		function render() {
			$container = $('<div></div>', {'class': classname + ' ' + classname + '-' + sides[hSide] + ' ui-widget ui-widget-content ui-corner-all ui-front container'})
